...
class CheckoutScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // TODO (Screen 4): Replace body with full checkout UI.
      // Requirements:
      //  • Address input field
      //  • Payment method selector (COD, Momo)
      //  • Order summary list
      //  • "Đặt Hàng" button → success dialog → clear cart → back to Home
      //  • Order history via DefaultTabController (Chờ xác nhận / Đang giao / ...)
